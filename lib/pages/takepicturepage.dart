...
import 'package:whatmedi3/imagesend/main_view_model.dart';
...
class TakePictureScreenState extends State<TakePictureScreen>
  ...
  Future<void> didChangeAppLifecycleState(AppLifecycleState state) async {
    if (state == AppLifecycleState.resumed) {
      ...
      ///앱에서 나간 상태인데 그러면 그냥 _controller?.dispose()하면 안되나?
      print("Paused");
            ...
            children: [
              ...
              IconButton(
                onPressed: () async {
                     ...
                     final String apiKey = "CHovamtreO5AafHVXcrg"; // Your API Key
                     final String modelEndpoint = "dataset/v"; // Set model endpoint (Found in Dataset URL)
                     final String imageName = "YOUR_IMAGE.jpg"; // Your image file name

                     Future<void> uploadImage() async {
                       try {
                         final url = Uri.parse("https://detect.roboflow.com/$modelEndpoint?api_key=$apiKey&name=$imageName");
                         final response = await http.post(
                           url,
                           body: {"base64": encodedImage}, // Replace encodedFile with your base64 encoded image
                         );
                  ...
                  //     "제품명": servermedidata[0]['title'],
                  //     "제조사": servermedidata[0]['corp'],
                  //     "ingredient": servermedidata[0]['ingredient'],
                  //     "효과": servermedidata[0]['effect'],
                  //     "사용법": servermedidata[0]['usage']
                  //   };
                  //
                  //   Navigator.of(context).push(MaterialPageRoute(
                  //       builder: (context) => SearchedPage(
